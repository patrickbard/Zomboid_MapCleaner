...
!function (n) {
    n.version = {versionStr: "3.0.0", major: parseInt("3", 10), minor: parseInt("0", 10), revision: parseInt("0", 10)};
    var t = {
...
!function (h) {
    ...
    h.extend(h, {
        ...
        getElementOffset: function (e) {
            var t, i, n = (e = h.getElement(e)) && e.ownerDocument, o = {top: 0, left: 0};
        ...
        pointInElement: function (e, t) {
            e = h.getElement(e);
            var i = h.getElementOffset(e), n = h.getElementSize(e);
        ...
        makeCenteredNode: function (e) {
            ...
            h.extend(t[0].style, {display: "table", height: "100%", width: "100%"});
            h.extend(t[1].style, {display: "table-row"});
            h.extend(t[2].style, {display: "table-cell", verticalAlign: "middle", textAlign: "center"});
            t[0].appendChild(t[1]);
            t[1].appendChild(t[2]);
            t[2].appendChild(e);
            return t[0]
        ...
        setElementOpacity: function (e, t, i) {
            ...
            if (h.Browser.opacity) e.style.opacity = t < 1 ? t : ""; else if (t < 1) {
        ...
        normalizeEventListenerOptions: function (e) {
            return void 0 !== e ? "boolean" == typeof e ? h.supportsEventListenerOptions ? {capture: e} : e : h.supportsEventListenerOptions ? e : void 0 !== e.capture && e.capture : !!h.supportsEventListenerOptions && {capture: !1}
        },
        addEvent: function () {
        ...
        makeAjaxRequest: function (e, t, i) {
            ...
            a.onreadystatechange = function () {
                if (4 === a.readyState) {
                    ...
                    if (200 <= a.status && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s) t(a); else {
        ...
        jsonp: function (e) {
            var i, t = e.url, n = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
                o = e.callbackName || "openseadragon" + h.now(), r = window[o], s = "$1" + o + "$2",
    ...
    h.console = window.console || {log: e, debug: e, info: e, warn: e, error: e, assert: e};
    var t = {
        bmp: !(h.Browser = {vendor: h.BROWSERS.UNKNOWN, version: 0, alpha: !0}),
        jpeg: !0,
        jpg: !0,
        png: !0,
        tif: !1,
...
!function (u) {
    ...
    u.MouseTracker = function (e) {
        n.push(this);
        var t = arguments;
        u.isPlainObject(e) || (e = {element: t[0], clickTimeThreshold: t[1], clickDistThreshold: t[2]});
        ...
        d[this.hash] = {
            ...
            losecapture: function (e) {
                !function (e, t) {
                    var i = {id: u.MouseTracker.mousePointerId, type: "mouse"};
            ...
            gotpointercapture: function (e) {
                !function (e, t) {
                    var i = {originalEvent: t, eventType: "gotpointercapture", pointerType: f(t), isEmulated: !1};
                    L(e, i);
                    t.target === e.element && F(e, {id: t.pointerId, type: f(t)}, !0);
                    i.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            lostpointercapture: function (e) {
                !function (e, t) {
                    var i = {originalEvent: t, eventType: "lostpointercapture", pointerType: f(t), isEmulated: !1};
                    L(e, i);
                    t.target === e.element && F(e, {id: t.pointerId, type: f(t)}, !1);
                    i.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
    ...
    u.MouseTracker.prototype = {
        destroy: function () {
            ...
            var t, i, n = d[this.hash], o = n.activePointersLists.length;
            ...
            var e, t = d[this.hash], i = t.activePointersLists.length, n = 0;
    ...
    function o() {
        var e, t, i, n, o, r, s = l.length, a = u.now();
        n = a - c;
        c = a;
        for (e = 0; e < s; e++) {
    ...
    function p(e) {
        var t, i, n, o, r, s = d[e.hash], a = s.activePointersLists.length;
    ...
    function v(e, t) {
        var i;
        var n;
        if (u.MouseTracker.havePointerCapture) if (u.MouseTracker.havePointerEvents) {
    ...
    function P(e, t, i) {
        ...
        var r = null;
        n = t.deltaY < 0 ? 1 : -1;
        L(e, o = {originalEvent: t, eventType: "wheel", pointerType: "mouse", isEmulated: t !== i});
    ...
    function R(e, t) {
        var i = {id: m(t), type: f(t), isPrimary: y(t), currentPos: w(t), currentTime: u.now()};
        var n = {originalEvent: t, eventType: "pointerenter", pointerType: i.type, isEmulated: !1};
        L(e, n);
        M(e, n, i)
    }
    ...
    function _(e, t) {
        var i = {id: m(t), type: f(t), isPrimary: y(t), currentPos: w(t), currentTime: u.now()};
        var n = {originalEvent: t, eventType: "pointerleave", pointerType: i.type, isEmulated: !1};
        L(e, n);
        N(e, n, i)
    }
    ...
    function D(e, t) {
        ...
        o.shouldCapture && (n ? F(e, i, !0) : function (e, t) {
            var i;
            if (u.MouseTracker.havePointerCapture) if (u.MouseTracker.havePointerEvents) try {
    ...
    function I(e, t) {
        ...
        var n = {
            originalEvent: t,
            eventType: "pointerup",
            pointerType: (i = {id: m(t), type: f(t), isPrimary: y(t), currentPos: w(t), currentTime: u.now()}).type,
            isEmulated: !1
        };
        L(e, n);
        W(e, n, i, t.button);
    ...
    function A(e, t, i, n) {
        var o, r = d[e.hash], s = e.getActivePointersListByType(i.type);
    ...
    function W(e, t, i, n) {
        var o, r, s, a, l = d[e.hash], h = e.getActivePointersListByType(i.type), c = !1;
        ...
        if (0 === n) {
            ...
            if (!t.preventGesture && !t.defaultPrevented) if (c) {
    ...
    function V(n, o, r) {
        var e, t, i, s = d[n.hash], a = n.getActivePointersListByType(r.type);
...
!function (v) {
    ...
    v.Viewer = function (e) {
        ...
        this.toolbar && (this.toolbar = new v.ControlDock({element: this.toolbar}));
        this.bindStandardControls();
        c[this.hash].prevContainerSize = u(this.container);
        this.world = new v.World({viewer: this});
        ...
        this.imageLoader = new v.ImageLoader({jobLimit: this.imageLoaderLimit, timeout: e.timeout});
        this.tileCache = new v.TileCache({maxImageCacheCount: this.maxImageCacheCount});
    ...
    v.extend(v.Viewer.prototype, v.EventSource.prototype, v.ControlDock.prototype, {
        isOpen: function () {
            ...
            for (var t = 0; t < i.length; t++) !function (i) {
                v.isPlainObject(i) && i.tileSource || (i = {tileSource: i});
                if (void 0 !== i.index) {
            ...
            if (v.isArray(i.tileSource)) setTimeout(function () {
                ...
                !function (n, o, r, s, a) {
                    var l = n;
                    if ("string" === v.type(o)) if (o.match(/^\s*<.*>\s*$/)) o = v.parseXml(o); else if (o.match(/^\s*[{[].*[}\]]\s*$/)) try {
                        var e = v.parseJSON(o);
                        o = e
                    } catch (e) {
                    }
            ...
            function s() {
                ...
                for (; o._loadQueue.length && (e = o._loadQueue[0]).tileSource;) {
                    ...
                    if (o.navigator) {
                        i = v.extend({}, e.options, {replace: !1, originalTiledImage: t, tileSource: e.tileSource});
            ...
            var t = v.extend({}, e, {tileSource: {type: "image", url: e.url}});
            delete t.url;
            ...
            var e = v.delegate(this, m), t = v.delegate(this, f), i = v.delegate(this, this.goToNextPage),
                n = v.delegate(this, this.goToPreviousPage), o = this.navImages, r = !0;
            if (this.showSequenceControl) {
                ...
                if (r) {
                    ...
                    this.toolbar ? this.toolbar.addControl(this.pagingControl, {anchor: v.ControlAnchor.BOTTOM_RIGHT}) : this.addControl(this.pagingControl, {anchor: this.sequenceControlAnchor || v.ControlAnchor.TOP_LEFT})
                }
            }
            return this
        }, bindStandardControls: function () {
            var e = v.delegate(this, z), t = v.delegate(this, F), i = v.delegate(this, M), n = v.delegate(this, L),
                o = v.delegate(this, N), r = v.delegate(this, W), s = v.delegate(this, V), a = v.delegate(this, G),
                l = v.delegate(this, U), h = v.delegate(this, j), c = v.delegate(this, m), u = v.delegate(this, f),
            ...
            if (this.showNavigationControl) {
                ...
                if (g) {
                    ...
                    this.toolbar ? this.toolbar.addControl(this.navControl, {anchor: this.navigationControlAnchor || v.ControlAnchor.TOP_LEFT}) : this.addControl(this.navControl, {anchor: this.navigationControlAnchor || v.ControlAnchor.TOP_LEFT})
            ...
            var o;
            o = v.isPlainObject(e) ? e : {element: e, location: t, placement: i, onDraw: n};
    ...
    function h(e, t) {
        ...
        var i = null;
        if (t.element) i = v.getElement(t.element); else {
...
!function (d) {
    ...
    d.TileSource.prototype = {
        getTileSize: function (e) {
            ...
            var t = this.dimensions.times(this.getLevelScale(e)), i = 1 / t.x * d.pixelDensityRatio,
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
        supports: function (e, t) {
            ...
            var o, r, s, a, l, h, c, u, d, p, g, v, m, f = Math.pow(.5, this.maxLevel - e),
                y = Math.ceil(this.width * f), w = Math.ceil(this.height * f);
...
!function (u) {
    ...
    u.ReferenceStrip = function (e) {
        var t, i, n, o = e.viewer, r = u.getElementSize(o.element);
        if (!e.id) {
        ...
        if (e.width && e.height) {
            ...
            o.addControl(this.element, {anchor: u.ControlAnchor.BOTTOM_LEFT})
            ...
            o.addControl(this.element, {anchor: u.ControlAnchor.TOP_LEFT})
        }
    ...
    u.ReferenceStrip.prototype = {
        setFocus: function (e) {
            var t, i = this.element.querySelector("#" + this.element.id + "-" + e),
                n = u.getElementSize(this.viewer.canvas), o = Number(this.element.style.width.replace("px", "")),
    ...
    function l(e) {
        ...
        if (this.element) {
            var t = Number(this.element.style.marginLeft.replace("px", "")),
                ...
                o = Number(this.element.style.height.replace("px", "")), r = u.getElementSize(this.viewer.canvas);
            if ("horizontal" === this.scroll) {
                if (0 < -e.delta.x) {
                    if (t > -(n - r.x)) {
    ...
    function c(e, t, i) {
        ...
        o = Math.ceil(t / n) + 5;
        for (a = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o; a < r && a < e.panels.length; a++) if (!(l = e.panels[a]).activePanel) {
            var h;
            var c = e.viewer.tileSources[a];
            h = c.referenceStripThumbnailUrl ? {type: "image", url: c.referenceStripThumbnailUrl} : c;
            s = new u.Viewer({
                id: l.id,
                tileSources: [h],
                element: l,
    ...
    c.Overlay.prototype = {
        _init: function (e) {
            ...
            if (this.onDraw) this.onDraw(o, r, this.element); else {
                ...
                // Commenting here becasue this property is being controlled on the app
                // a.display = "block"
            }
...
!function (T) {
    T.TiledImage = function (e) {
        ...
        this._drawingHandler = function (e) {
            t.viewer.raiseEvent("tile-drawing", T.extend({tiledImage: t}, e))
        }
    };
    T.extend(T.TiledImage.prototype, T.EventSource.prototype, {
        needsDraw: function () {
            ...
            return {lowestLevel: Math.min(e, i), highestLevel: i}
            ...
            for (var h = r; o <= h; h--) {
                ...
                s = function (e, t, i, n, o, r, s, a, l) {
                    ...
                    for (var m = d.x; m <= p.x; m++) for (var f = d.y; f <= p.y; f++) {
                        var y;
                        if (e.getFlip()) {
                            var w = (g.x + m % g.x) % g.x;
                            y = m + g.x - w - w - 1
                        ...
                        null !== s.intersection(e.getTileBounds(n, y, f)) && (l = function (e, t, i, n, o, r, s, a, l, h, c, u) {
                            ...
                            !function (e, t, i, n, o, r) {
                                ...
                                var l = i.pixelFromPointNoRotate(s, !0), h = i.pixelFromPointNoRotate(s, !1),
                                    ...
                                    u = i.deltaPixelsFromPointsNoRotate(a, !1), d = h.plus(u.divide(2)),
                            ...
                            if (!d.loaded) if (d.context2D) x(e, d); else {
    ...
    g.TileCache.prototype = {
        numTilesLoaded: function () {
            ...
            if (!n) {
                ...
                n = this._imagesLoaded[e.tile.cacheKey] = new m({image: e.image});
            ...
            this._tilesLoaded[i] = new v({tile: e.tile, tiledImage: e.tiledImage})
